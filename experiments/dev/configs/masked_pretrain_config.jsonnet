...
local train_data_config = import "./prepro_config_masked_train.jsonnet";
local valid_data_config = import "./prepro_config_masked_valid.jsonnet";
local test_data_config = import "./prepro_config_masked_test.jsonnet";

local reverse_pretrain_config = import "./reverse_pretrain_config.jsonnet";
...

{
  global_setting: {
    ...
    seed: 42,
    tag: "%s_masked_pretrain" % std.extVar("TAG"),
  ...
  pl_module_setting: {
    ...
    model_name_or_path: "%s/%s" % [
      reverse_pretrain_config.Trainer.weights_save_path,
      reverse_pretrain_config.global_setting.pl_model_name,
    ],
