...
local train_data_config = import "./prepro_config_EvalScoreRegression_train.jsonnet";
local valid_data_config = import "./prepro_config_EvalScoreRegression_valid.jsonnet";
local test_data_config = import "./prepro_config_EvalScoreRegression_test.jsonnet";

local masked_pretrain_config = import "./masked_pretrain_config.jsonnet";
local before_config = import "./eval_score_regression_addtional_5_config.jsonnet";

{
  global_setting: {
    pl_model_name: "OthelloBertTokenRegression",
    seed: 42,
    tag: "%s_eval_score_regression_additional_6" % std.extVar("TAG"),
